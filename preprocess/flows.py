...
FLOWNET_INPUT_WIDTH = {"ped2": 512 * 2, "Avenue19": 512 * 2, "shanghaitech": 1024, "freeway": 512 * 2, "gu":512 * 2,}
FLOWNET_INPUT_HEIGHT = {"ped2": 384 * 2, "Avenue19": 384 * 2, "shanghaitech": 640, "freeway": 384 * 2, "gu":384 * 2,}
...
def extracting_flows(dataset_name, root, train):
    ...
    flownet2 = FlowNet2()
    path = './checkpoints/FlowNet2_checkpoint.pth.tar'
...
if __name__ == '__main__':
    ...
    parser.add_argument("--dataset_name", type=str, default="gu", help='dataset name')
    parser.add_argument("--train", default='train', help='train or test data')
